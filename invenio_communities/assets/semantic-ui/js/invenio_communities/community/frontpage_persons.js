...
if (userCommunitiesContainer) {
  ReactDOM.render(
    <CommunitiesCardGroup
      fetchDataUrl="/api/user/persons?q=&sort=newest&page=1&size=5"
      emptyMessage="You are not an admin of any person."
...
if (newCommunitiesContainer) {
  ReactDOM.render(
    <CommunitiesCardGroup
      fetchDataUrl="/api/persons?q=&sort=newest&page=1&size=5"
      emptyMessage="There are no new persons."
      defaultLogo="/static/images/square-placeholder.png"
    />,
